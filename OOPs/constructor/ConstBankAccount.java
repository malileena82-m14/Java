...
Description: Create BankAccount class with accountNumber, customerName and balance. Initialize using constructor. 
...
Check if balance < 1000 then print "Minimum Balance Warning" else "Valid Balance". Display customer name and status.*/
...
class BankAccount
{
	...
	public BankAccount(int num,String name,int balance)
	{
		this.num = num ;
		this.name = name;
