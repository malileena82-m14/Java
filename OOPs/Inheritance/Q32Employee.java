...
class SeniorDeveloper extends Developer
{
	...
	void show()
	{
		System.out.println("Name: "+name+", Total Salary: "+(salary + bonus + stockBonus));
	}
}
class Q32Employee
{
	public static void main(String x[])
	{
		...
		SeniorDeveloper a[] = new SeniorDeveloper[num];
		...
		for(int i=0;i<num;i++)
		{
			...
			a[i] = new SeniorDeveloper(name,salary,bonus,stockBonus);
		}
		for(int i=0;i<num;i++)
		{
			a[i].show();
