...
{
	int ratePerKm;
	void display(String customerName,int distance,int ratePerKm)
	{
	...
	void show()
	{
		System.out.println("Customer: "+customerName+", Fare: "+(distance*ratePerKm));
	}
}
class Q16Ride
{
	public static void main(String x[])
	{
		...
		for(int i=0;i<num;i++)
		{
			...
			a[i].display(customerName,distance,ratePerKm);
		}
		for(int i=0;i<num;i++)
		{
			a[i].show();
