/*Question 46: Chef is watching TV. The current volume of the TV is XX. Pressing the volume up button 
...
• The first and only line of each test case contains two integers XX and YY - the initial volume 
  and final volume of the TV.
Output Format
...
class Tv
{
	public static void main(String x[])
	{
		...
		{
			v = Y-X;
			System.out.println("incrase the volume = "+v);
		}
		else
		{
			v = X-Y;
			System.out.println("decrease the volume = "+v);
		}
	}
}