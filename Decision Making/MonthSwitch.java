/*Question 52: Write a Java program using a switch case to input a month number (1-12) and display the number
 of days in that month. Consider leap year for February.
Input:
Month = 2
Year = 2024
...
Explanation:
The program uses a switch case for month numbers. For February (month 2), it checks whether the given year is 
a leap year. Since 2024 is a leap year, February has 29 days.*/
