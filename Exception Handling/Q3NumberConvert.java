...
Accept a number in string format from the user and convert it into integer using parsing. If the input is not numeric, 
...
Catch NumberFormatException and display message that input must be numeric. This exception handling prevents program crash and 
provides user feedback.*/

import java.util.*;
class Q3NumberConvert
{
